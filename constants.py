...
VAR_THYMIO_VL = 78.53 * (SPEED_COEFF**2) * (PIXEL_PER_CM**2) # [px^2/s^2]
VAR_THYMIO_VR = 33.79 * (SPEED_COEFF**2) * (PIXEL_PER_CM**2) # [px^2/s^2]
VAR_THYMIO_V = (0.5**2)*(VAR_THYMIO_VL+VAR_THYMIO_VR) # [px^2/s^2]
VAR_THYMIO_OMEGA = ((0.5*PIXEL_PER_CM/WHEEL_AXLE_LENGTH)**2)*(VAR_THYMIO_VL-VAR_THYMIO_VR)
